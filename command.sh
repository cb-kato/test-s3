...
curl localhost:8080 \
  ...
  -H "ce-subject: objects/exported/exported_000000000000.parquet" \
  -d '{
    ...
    "id": "test-cookbizjp-ga4-export-pageview/exported/exported_000000000000.parquet/1644977077542369",
    "kind": "storage#object",
    ...
    "metageneration": "1",
    "name": "exported/exported_000000000000.parquet",
