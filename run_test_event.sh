...
curl localhost:8080 \
  ...
  -H "ce-source: //storage.googleapis.com/projects/_/buckets/cookbizjp-ga4-exported-data" \
  -H "ce-subject: objects/20220228_000000000000.parquet" \
  -d '{
    "bucket": "cookbizjp-ga4-exported-data",
    "contentType": "application/octet-stream",
    "crc32c": "Xtj/QQ==",
    "etag": "COG7+5KRg/YCEAE=",
    "generation": "1644977077542369",
    "id": "cookbizjp-ga4-exported-data/20220228_000000000000.parquet/1644977077542369",
    "kind": "storage#object",
    ...
    "metageneration": "1",
    "name": "20220228_000000000000.parquet",
